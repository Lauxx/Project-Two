...
var HugCard = React.createClass({
	...
	afterOpenModal: function(){
		console.log(this.refs, 'afterOpenModal here');
	...
	modalDisplay: function(){
		...
		console.log(this.props.user, 'modal card here');
					...
					<div className="card">
						<div className="avenir">
    						...
    						<div className="col-lg-7 col-md-7">
    							...
    							<a className='avenir' href={'https://www.google.com/maps/dir/Current+Location/' 
    								+ this.props.lat + ',' + this.props.lng }> Get Directions </a>  						
  								<a onClick={ this.openModal.bind(null, this.props.id) } className="comment-glyph userIcon">
